...
# genres=info_cards.findAll(text=True)
#still need to get genres and agent websites
#clean this up and make getnameandemail functions etc
#read up on creating an array of dictionaries